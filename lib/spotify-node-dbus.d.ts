// https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/spotify-node-applescript/index.d.ts
...
/*~ Promise-based versions of the above functions are available through the `promises` object. */
export const promises: {
    playTrack(uri: string): Promise<void>;
    playTrackInContext(uri: string, contextUri: string): Promise<void>;
    getTrack(): Promise<TrackInfo>;
    getState(): Promise<SpotifyState>;
    jumpTo(second: number): Promise<void>;
    play(): Promise<void>;
    pause(): Promise<void>;
    ...
    muteVolume(): Promise<void>;
    unmuteVolume(): Promise<void>;
    isRunning(): Promise<boolean>;
    isRepeating(): Promise<boolean>;
    setRepeating(repeating: boolean): Promise<void>;
    toggleRepeating(): Promise<void>;
    isShuffling(): Promise<boolean>;
    setShuffling(shuffling: boolean): Promise<void>;
    toggleShuffling(): Promise<void>;
};
